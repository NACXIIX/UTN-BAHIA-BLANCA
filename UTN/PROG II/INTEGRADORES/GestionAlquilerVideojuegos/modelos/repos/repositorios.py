from modelos.repos.repositorio_generos import Repo_Generos
from modelos.repos.repositorio_videojuegos import Repo_videojuegos
from modelos.repos.repositorio_desarrollador import Repo_desarrolladoras
